...
for sample in samples:
    # Tokenizes the samples via the split method. In real life,
    # you’d also strip punctuation and special characters from the samples
...
print('Token indexes: ', token_index)
